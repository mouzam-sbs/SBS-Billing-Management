   ...
   public class CustomerBusiness: ICustomer
    {
        ...
        public List<CustomerModel> CustomerList()
        {
            ...
            _customerlist = (from item in _CustomerList
                             select new CustomerModel
                             {
                                 ...
                                 ProfilePic1 = item.ProfilePic1,
                                 IdProofPic4=item.ProfilePic1,
                                 AlternateMobile=item.AlternateNumber,
                                 Address=item.Address,
                                 AttachmentPic1=item.AttachmentPic1,
                                 AttachmentPic2=item.AttachmentPic2,
                                 AttachmentPic3=item.AttachmentPic3,
        ...
        public CustomerModel Getbyid(int id)
        {
            ...
            _customer = new CustomerModel
            {
                ...
                ProfilePic1 = customerbyId.ProfilePic1,
                IdProofPic4 = customerbyId.ProfilePic1,
                AlternateMobile = customerbyId.AlternateNumber,
                Address = customerbyId.Address,
                AttachmentPic1 = customerbyId.AttachmentPic1,
                AttachmentPic2 = customerbyId.AttachmentPic2,
                AttachmentPic3 = customerbyId.AttachmentPic3,
                CreatedOn = customerbyId.CreatedOn
            };
            _customer.OrderList = new OrderBusiness().CustomerInvoiceList(id,true);
            return _customer;
        }
